				...
				<div class="right_block span3">
					<div class="actions">
						...
						<ul class="add-to-links">
							<li>
	<a onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', $('#idCombination').val(), 1); return false;" class="add-wishlist" id="wishlist_button" href="#">Add to Wishlist</a>
	</li>
