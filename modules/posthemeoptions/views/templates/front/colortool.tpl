				...
				<div class="cl-container">
					<div class="cl-table">
						<div class="cl-tr cl-tr-style">
							<div class="cl-td-l cl-td-layout cl-td-layout1"><a href="#" id="red" title="red"><span></span>{l s='Red'}</a></div>
							<div class="cl-td-l cl-td-layout cl-td-layout2"><a href="#" id="blue" title="blue"><span></span>{l s='Blue'}</a></div>
							<div class="cl-td-l cl-td-layout cl-td-layout3"><a href="#" id="green" title="green"><span></span>{l s='Green'}</a></div>
							<div class="cl-td-l cl-td-layout cl-td-layout4"><a href="#" id="pink" title="pink"><span></span>{l s='Pink'}</a></div>
							<div class="cl-td-l cl-td-layout cl-td-layout5"><a href="#" id="orange" title="orange"><span></span>{l s='Orange'}</a></div>
							<div class="cl-td-l cl-td-layout cl-td-layout6"><a href="#" id="brown" title="brown"><span></span>{l s='Brown'}</a></div>
						</div>
					</div>
                </div>		
			</div>
