            ...
            <div class="flexslider carousel">
					...
					{if $slideOptions.show_price == 1 AND !isset($restricted_country_mode) AND !$PS_CATALOG_MODE}
                                        ...
                                        <p class="product_name">
                                                <a href="{$link->getProductLink($categoryProduct.id_product, $categoryProduct.link_rewrite, $categoryProduct.category, $categoryProduct.ean13)|escape:'html'}" title="{$categoryProduct.name|htmlspecialchars}">{$categoryProduct.name|truncate:90:'...'|escape:'htmlall':'UTF-8'}</a>
                                        </p>
