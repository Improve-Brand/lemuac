...
class poslogo extends Module {
    ...
    public function install()
	{
		...
		$tab->add();
                ...
                Configuration::updateValue($this->name . '_width_item', 288);
	...
	public function getContent()
	{
        ...
        public function getLogo() { 
                        ...
                        $sql = 'SELECT * FROM `' . _DB_PREFIX_ . 'pos_logo` ps 
								LEFT JOIN `' . _DB_PREFIX_ . 'pos_logo_lang`  psl ON ps.id_pos_logo = psl.id_pos_logo
								LEFT JOIN `' . _DB_PREFIX_ . 'pos_logo_shop`  s ON ps.id_pos_logo = s.id_pos_logo 
	...
	function hookBrandSlider($params) { 
		$options = array(
            ...
            return $this->display(__FILE__, 'poslogo.tpl');
	}
