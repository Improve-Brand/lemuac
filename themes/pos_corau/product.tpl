	...
	<div id="pb-left-column" class="span5">
		...
		{if $have_image}
			<span id="view_full_size">
				<img id="bigpic" src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'pos_large')|escape:'html'}"{if $jqZoomEnabled && $have_image} class="jqzoom"{/if} title="{$product->name|escape:'htmlall':'UTF-8'}" alt="{$product->name|escape:'htmlall':'UTF-8'}"/>
