...
{if $products}
	...
	<div class="wlp_bought">
		...
		{if $product@iteration%4==1}
		    <ul class="wlp_bought_list row-fluid">
		{/if}
			<li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="clearfix address span3 {if $smarty.foreach.i.index % 2}alternate_{/if}item">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						<p class="wishlist_product_detail">
