		...
		<li class="ajax_block_product {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if} {if $smarty.foreach.products.index % 2}alternate_item{else}item{/if} clearfix">
			<div class="row-fluid">
				<div class="left_block span4">
					<a class = "bigpic_{$product.id_product}_list product_img_link" href="{$product.link|escape:'htmlall':'UTF-8'}" title="{$product.name|escape:'htmlall':'UTF-8'}">
				...
				<div class="right_block span3">
					<div class="actions">
						...
						<ul class="add-to-links">
							<li>
	<a onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', $('#idCombination').val(), 1,'list'); return false;" class="add-wishlist wishlist_button" href="#">Add to Wishlist</a>
	</li>
      ...
      {if $smarty.get.product_mode == 'grid'}
		...
		{/if}
			...
			<div class="item-inner">
				<a class = "bigpic_{$product.id_product}_grid product_image" href="{$product.link|escape:'html'}" title="{$product.name|escape:html:'UTF-8'}" ><img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'pos_product')|escape:'html'}" alt="{$product.name|escape:html:'UTF-8'}" />
				...
				{if $product.specific_prices}<span class="sale">{l s='Sale'}</span>{/if}
			       {/if}	
					...
					<ul class="add-to-links">
						<li>
<a onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', $('#idCombination').val(), 1,'grid'); return false;" class="add-wishlist wishlist_button" href="#">Add to Wishlist</a>
</li>
