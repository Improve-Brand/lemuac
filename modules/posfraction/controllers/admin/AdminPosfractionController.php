...
class AdminPosfractionController extends ModuleAdminController
{
	public function __construct()
	{
		$this->table = 'pos_fraction';
		$this->className = 'Fractionslideshow';
		$this->lang = true;
		$this->deleted = false;
        ...
        public function renderList() {
            ...
            $this->fields_list = array(
                ...
                'width' => array(
                    'title' => $this->l('Width Image'),
                    'width' => 90,
                ),
				'height' => array(
                    'title' => $this->l('Height Image'),
                    'width' => 90,
                ),
			 'active' => array(
...
//            
	...
	protected function uploadImage($id, $name, $dir, $ext = false, $width = null, $height = null)
	{
		if (isset($_FILES[$name]['tmp_name']) && !empty($_FILES[$name]['tmp_name']))
		{
			...
			// Copy new image
			if (empty($this->errors) && !ImageManager::resize($tmp_name, _PS_MODULE_DIR_.'posfraction'.DS.'images'.DS.$id.'.'.$this->imageType, (int)$width, (int)$height, ($ext ? $ext : $this->imageType)))
