...
<li><a class="link-wishlist wishlist_block" href="{$context->link->getModuleLink('blockwishlist', 'mywishlist')}" title="{l s='My wishlist' mod='blockpermanentlinks'}">{l s='My wishlist' mod='blockpermanentlinks'}</a></li>
	...
	{if $logged}
			...
			<li class="last"><a class="link-out" href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html'}" title="{l s='Log out' mod='blockpermanentlinks'}"  rel="nofollow">{l s='Log out' mod='blockpermanentlinks'}</a></li>
		{else}
			<li class="last"><a class="link-login" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Login' mod='blockpermanentlinks'}"  rel="nofollow">{l s='Login' mod='blockpermanentlinks'}</a></li>
	{/if}
