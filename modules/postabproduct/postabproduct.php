...
class postabproduct extends Module {
	...
	public function __construct() {
		...
		$this->description 	= $this->l('Product Tabs');
    ...
    // Hook Home
	public function hookTabsProducts($params) {
			...
			if(Configuration::get($this->name . '_show_new')) {
				$productTabs[] = array('id'=>'new_product', 'name' => $this->l('New Arrival'), 'productInfo' => $newProducts);
			}
			if(Configuration::get($this->name . '_show_sale')) {
				$productTabs[] = array('id'=> 'special_product','name' => $this->l('OnSale'), 'productInfo' =>  $specialProducts);
			}
			if(Configuration::get($this->name . '_show_best')) {
				$productTabs[] = array('id'=>'besseller_product','name' => $this->l('Bestseller'), 'productInfo' =>  $bestseller);
			}
			if(Configuration::get($this->name . '_show_feature')) {
				$productTabs[] = array('id'=>'feature_product','name' => $this->l('Feature Products'), 'productInfo' =>  $featureProduct);
			}
	 ...
	 $tabEffect = array();
		...
		<form action="'.$_SERVER['REQUEST_URI'].'" method="post">
                  <fieldset>
                    ...
                    <label>'.$this->l('Products on Row: ').'</label>
                    <div class="margin-form">
