	...
	<div class="flexslider carousel">
		<ul class="slides" >
			{foreach from=$products item=product name=products}
              ...
              {/if}
             {/if} 
             <span class="old_price">{if !$priceDisplay}{displayWtPrice p=$product.price_without_reduction}{else}{displayWtPrice  p={Tools::ps_round($product['price_without_reduction'], 2)} }{/if}</span>
